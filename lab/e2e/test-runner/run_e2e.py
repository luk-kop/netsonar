...
RANGE_EXPECTATIONS = [
    ...
    ("probe_phase_duration_seconds", {"target_name": "http-https-via-proxy", "phase": "proxy_connect"}, 0.0, 2.0),
    ("probe_phase_duration_seconds", {"target_name": "http-https-via-proxy", "phase": "tls_handshake"}, 0.0, 2.0),
